...
export default function BottomNav() {
    ...
    return (
        <nav className="bottom-nav">
            <Link href="/app/home" className={`nav-item ${isActive("/app/home") ? "active" : ""}`}>
            ...
            <Link href="/app/map" className={`nav-item ${isActive("/app/map") ? "active" : ""}`}>
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
            ...
            <Link href="/app/all" className={`nav-item ${isActive("/app/all") ? "active" : ""}`}>
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
